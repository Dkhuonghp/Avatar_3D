...
interface CSSDirective extends LazyInjected {
    (context: {
        tw: TW;
    }): CSSRules;
}
declare const css: (parameter: CSSRules) => CSSDirective;
interface CSSKeyframes extends LazyInjected {
 ...
 * @param waypoints
 */
declare const keyframes: (parameter: Record<string, CSSProperties>) => CSSKeyframes;
/**
 *
 * ```js
...
export { CSSDirective, CSSKeyframes, LazyInjected, animation, css, keyframes };
